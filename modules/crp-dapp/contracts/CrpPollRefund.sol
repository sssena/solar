...
/// @title the CrpPollRefund contract (version 0.1)
/// @author sykang
contract CrpPollRefund is CrpInfc {    
    using SafeMath
    for uint256;
    ...
    uint256 public disagree_addr; // 실시간 반대 계좌
    ...
    // private variable   
    string constant contract_type = "POLLREFUND";
    ...
    /// @author sykang
    /// @notice the constructor of CrpRefundPoll contract    
    ...
    constructor(uint256 _start_time, uint256 _end_time, address _main)
    public {
        owner = msg.sender;
