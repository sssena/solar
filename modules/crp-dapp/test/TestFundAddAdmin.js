...
function Usage() {
    console.log("Usage --> ");
    console.log("    node test/TestFundAddAdmin.js [argv1] [argv2] [argv3] [argv4]");
    console.log("....argv1: Owner 계정 (Index)");
    console.log("....argv2: Owner 암호");
    console.log("....argv3: Crpfund 컨트랙트 주소");
    console.log("....argv4: Admin으로 할당할 계정");    
}
...
let RunProc = async () => {
    try {
        ...
        if (await act.tryActions(api_fund.addAdmin, showProgress, 5, true, owner, passwd, fund, amount) == false) {
