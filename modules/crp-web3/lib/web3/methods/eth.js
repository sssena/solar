...
var methods = function () {
    ...
    var getPermissionTx = new Method({
        name: 'getPermissionTx',
        call: 'eth_getPermissionTx',
        params: 1,
        inputFormatter: [formatters.inputAddressFormatter]
    });

    var getMainContractAddress = new Method({
        name: 'getMainContractAddress',
        call: 'eth_getMainContractAddress',
        params: 1,
        inputFormatter: [formatters.inputAddressFormatter]
    });
